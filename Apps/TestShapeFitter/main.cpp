...
int main() {
	...
	PointCloud<PointNormal> global_pc("../159_coverage_pc_as_is.obj");
	ShapeModelImporter::load_obj_shape_model("../shape_cgal.obj",1.,true,psr_shape);
	...
	shape_fitter.fit_shape_batch(2,0);
