...
#define N_ITER_BUNDLE_ADJUSTMENT 100 // Number of iterations in bundle adjustment

// IOD parameters
#define IOD_RIGID_TRANSFORMS_NUMBER 399 // Number of rigid transforms to be used in each IOD run
