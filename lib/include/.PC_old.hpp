...
public:
	...
	*/
	...
	std::vector<std::shared_ptr<PointNormal> > get_points_in_sphere(const arma::vec & test_point, const double & radius) const;
	...
	std::shared_ptr<KDTreePCSimple> kdt_points_simple;
